...
public struct Color : IFlatbufferObject
{
  ...
  public static Offset<Color> CreateColor(FlatBufferBuilder builder, sbyte A, sbyte R, sbyte G, sbyte B) {
    builder.Prep(1, 4);
    builder.PutSbyte(B);
    builder.PutSbyte(G);
    builder.PutSbyte(R);
...
#if ENABLE_SPAN_T
  public Span<byte> GetValueBytes() { return __p.__vector_as_span(8); }
#else
...
public struct EntityInformation : IFlatbufferObject
{
  ...
  public static VectorOffset CreateValuesVectorBlock(FlatBufferBuilder builder, Offset<EntityValueInformation>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
...
#if ENABLE_SPAN_T
  public Span<byte> GetClientNameBytes() { return __p.__vector_as_span(4); }
#else
...
public struct SvRep_ClientConnect : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<byte> GetServerNameBytes() { return __p.__vector_as_span(4); }
#else
  ...
  public ServerProperties ServerProperties { get { int o = __p.__offset(18); return o != 0 ? (ServerProperties)__p.bb.GetUshort(o + __p.bb_pos) : 0; } }
  public bool MutateServerProperties(ServerProperties serverProperties) { int o = __p.__offset(18); if (o != 0) { __p.bb.PutUshort(o + __p.bb_pos, (ushort)serverProperties); return true; } else { return false; } }
  ...
  public static void StartSvRep_ClientConnect(FlatBufferBuilder builder) { builder.StartObject(9); }
  ...
  public static void AddServerProperties(FlatBufferBuilder builder, ServerProperties serverProperties) { builder.AddUshort(7, (ushort)serverProperties, 0); }
...
#if ENABLE_SPAN_T
  public Span<byte> GetClientUIDsBytes() { return __p.__vector_as_span(4); }
#else
...
public struct SvRep_GetClientList : IFlatbufferObject
{
  ...
  public static VectorOffset CreateClientsVectorBlock(FlatBufferBuilder builder, Offset<ClientInformation>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
...
#if ENABLE_SPAN_T
  public Span<byte> GetEntityUIDsBytes() { return __p.__vector_as_span(4); }
#else
...
public struct SvRep_GetEntityList : IFlatbufferObject
{
  ...
  public static VectorOffset CreateEntitiesVectorBlock(FlatBufferBuilder builder, Offset<EntityInformation>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
...
#if ENABLE_SPAN_T
  public Span<byte> GetEntityUIDsBytes() { return __p.__vector_as_span(6); }
#else
...
public struct RemoteControlCommand_StopServer : IFlatbufferObject
{
  ...
  public static Offset<RemoteControlCommand_StopServer> CreateRemoteControlCommand_StopServer(FlatBufferBuilder builder,
  ...
  public static void StartRemoteControlCommand_StopServer(FlatBufferBuilder builder) { builder.StartObject(2); }
  ...
  public static Offset<RemoteControlCommand_StopServer> EndRemoteControlCommand_StopServer(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<RemoteControlCommand_StopServer>(o);
  }
};
...
public struct ClReq_RemoteControlCommand : IFlatbufferObject
{
  ...
  public uint ClientUID { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public bool MutateClientUID(uint clientUID) { int o = __p.__offset(4); if (o != 0) { __p.bb.PutUint(o + __p.bb_pos, clientUID); return true; } else { return false; } }
  public URemoteControlCommand CommandType { get { int o = __p.__offset(6); return o != 0 ? (URemoteControlCommand)__p.bb.Get(o + __p.bb_pos) : URemoteControlCommand.NONE; } }
  public bool MutateCommandType(URemoteControlCommand command_type) { int o = __p.__offset(6); if (o != 0) { __p.bb.Put(o + __p.bb_pos, (byte)command_type); return true; } else { return false; } }
  public TTable? Command<TTable>() where TTable : struct, IFlatbufferObject { int o = __p.__offset(8); return o != 0 ? (TTable?)__p.__union<TTable>(o) : null; }

  public static Offset<ClReq_RemoteControlCommand> CreateClReq_RemoteControlCommand(FlatBufferBuilder builder,
      uint clientUID = 0,
      URemoteControlCommand command_type = URemoteControlCommand.NONE,
      int commandOffset = 0) {
    builder.StartObject(3);
  ...
  public static void StartClReq_RemoteControlCommand(FlatBufferBuilder builder) { builder.StartObject(3); }
  public static void AddClientUID(FlatBufferBuilder builder, uint clientUID) { builder.AddUint(0, clientUID, 0); }
  public static void AddCommandType(FlatBufferBuilder builder, URemoteControlCommand commandType) { builder.AddByte(1, (byte)commandType, 0); }
  public static void AddCommand(FlatBufferBuilder builder, int commandOffset) { builder.AddOffset(2, commandOffset, 0); }
  public static Offset<ClReq_RemoteControlCommand> EndClReq_RemoteControlCommand(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<ClReq_RemoteControlCommand>(o);
  }
};
...
public struct SvRep_RemoteControlCommand : IFlatbufferObject
{
  ...
  public static void StartSvRep_RemoteControlCommand(FlatBufferBuilder builder) { builder.StartObject(0); }
  public static Offset<SvRep_RemoteControlCommand> EndSvRep_RemoteControlCommand(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<SvRep_RemoteControlCommand>(o);
  }
};
...
#if ENABLE_SPAN_T
  public Span<byte> GetMessageBytes() { return __p.__vector_as_span(4); }
#else
...
public struct EntityUpdate : IFlatbufferObject
{
  ...
  public static VectorOffset CreateValuesVectorBlock(FlatBufferBuilder builder, Offset<EntityValue>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartValuesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
...
public struct EntityUpdates : IFlatbufferObject
{
  ...
  public static VectorOffset CreateUpdatesVectorBlock(FlatBufferBuilder builder, Offset<EntityUpdate>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
