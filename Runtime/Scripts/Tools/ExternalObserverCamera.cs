...
{
	/// <summary>
	/// Camera that follows the main camera, but with smoothing and without roll.
	/// Suitable to allow a larger audience to observe an XR user's view without the stark motion.
	/// </summary>
	/// 
	[AddComponentMenu("SentienceLab/Tools/External Observer Camera")]
